...
function index() {
  return (
    <div className="px-6 2xl:px-64 py-12">
      <section className="grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-y-6 lg:gap-x-6">
        <div className="relative lg:h-[500px] 2xl:h-[600px] w-full rounded-lg">
      ...
      <section className="grid grid-cols-2 xl:grid-cols-4 items-center justify-center pt-12 xl:pt-64 2xl:pt-32 pb-12 gap-6 lg:gap-x-6">
        <a href="" className="relative flex flex-col items-center justify-center font-semibold pt-2 lg:h-[250px] 2xl:h-[300px] w-full rounded-lg cursor-pointer">
